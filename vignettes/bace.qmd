...
# Now have a look at the final models and the pooled results
y_model <- bace_final1$pooled_models$models$y
summary(y_model)
plot(y_model)  
...
# Access the imputed datasets for each run. 
imputed_datasets <- bace_final1$imputed_datasets
...
# Now have a look at the final models and the pooled results
y_model <- bace_final$pooled_models$models$y
summary(y_model)
plot(y_model)  
