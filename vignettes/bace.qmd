...
nitt_list <- c(20000, 15000, 10000)
thin_list <- c(10, 5, 5)
burnin_list <- c(5000, 3000, 2000)
...
bace_impute5 <- bace_imp(fixformula = "y ~ x1 + x2",
                    ran_phylo_form = "~ 1 |species",
                             phylo = tree,
                              data = data,
                              runs = 5, nitt = nitt_list, thin = thin_list, burnin = burnin_list, species = TRUE)
```